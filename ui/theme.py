...
def apply_login_styles():
    ...
    .cx-demo-notice {
        margin: 14px 0 10px; padding: 9px 12px; border-radius: 9px;
        background: #FFF8E8; border: 1px solid #F5D78E;
        color: #7A4B00; font-size: 0.78rem; line-height: 1.4;
    }
    div[data-testid="stExpander"]:has(.cx-demo-account-list) details {
        background: #FFFFFF !important; border: 1px solid #D9E2F0 !important;
        border-radius: 12px !important; overflow: hidden;
    }
    div[data-testid="stExpander"]:has(.cx-demo-account-list) summary {
        background: #F7F9FD !important; color: #10203E !important;
        border-radius: 0 !important; min-height: 46px;
        font-weight: 800 !important;
    }
    div[data-testid="stExpander"]:has(.cx-demo-account-list) [data-testid="stExpanderDetails"] {
        padding: 12px !important; background: #FFFFFF !important;
    }
    .cx-demo-heading { color:#10203E; font-size:.82rem; font-weight:800; margin-bottom:2px; }
    .cx-demo-password { color:#7C8AA8; font-size:.74rem; margin-bottom:10px; }
    div[data-testid="stExpander"]:has(.cx-demo-account-list) .stButton > button {
        width: 100% !important; min-height: 42px !important; margin: 0 0 7px !important;
        padding: 7px 12px !important; border-radius: 9px !important;
        background: #F8FAFD !important; border: 1px solid #D9E2F0 !important;
        color: #1D3263 !important; font-size: .79rem !important;
        font-weight: 750 !important; text-align: left !important;
        justify-content: flex-start !important; white-space: normal !important;
        box-shadow: none !important;
    }
    div[data-testid="stExpander"]:has(.cx-demo-account-list) .stButton > button:hover {
        background: #EAF1FF !important; border-color: #8BB4FF !important;
        color: #155EEF !important; transform: translateY(-1px);
    }
...
def apply_reference_ui():
    ...
    div[data-testid="stHorizontalBlock"]:has(.cx-top-item) [data-testid="column"] {
        height: 76px !important; min-width: 0 !important;
        display: flex !important; align-items: center !important;
    }
    .cx-top-active [data-testid^="stPageLink"],
    .cx-top-item [data-testid^="stPageLink"] {
        width: 100% !important; height: 76px !important; padding: 0 8px !important;
        display: flex !important; align-items: center !important;
        overflow: visible !important;
    }
    div[data-testid="stHorizontalBlock"]:has(.cx-top-active) a p,
    div[data-testid="stHorizontalBlock"]:has(.cx-top-item) a p {
        ...
        color: #627695 !important; font-size: clamp(.82rem, 1.05vw, 1.02rem) !important;
        font-weight: 700 !important; white-space: normal !important;
        overflow: visible !important; text-overflow: clip !important;
        line-height: 1.16 !important; word-break: normal !important;
    }
    div[data-testid="stHorizontalBlock"]:has(.cx-top-active)
    ...
    [data-testid="stSidebar"] {
        top: 152px !important; width: 400px !important; min-width: 400px !important;
        background: var(--cx-navy) !important; border-right: 0 !important;
    }
    [data-testid="stSidebar"] > div { width: 400px !important; padding: 0 !important; }
    ...
    [data-testid="stFileUploaderDropzone"] [data-testid="stMarkdownContainer"] p {
        ...
        opacity: 1 !important;
        -webkit-text-fill-color: #627695 !important;
    }
    ...
    [data-testid="stFileUploaderFile"] * { color: var(--cx-text) !important; opacity: 1 !important; }
    ...
    /* Streamlit button groups / segmented controls.
       Explicit colours are required because Streamlit otherwise inherits the
       deployment's dark base theme for unselected choices. */
    ...
    button[data-testid*="stBaseButton-pills"] {
        ...
        -webkit-text-fill-color: #405678 !important;
    ...
    /* Secondary actions follow the Figma white-button treatment globally. */
    button[data-testid="stBaseButton-secondary"]:not([data-testid*="pills"]),
    ...
    button[data-testid="stBaseButton-secondary"]:not([data-testid*="pills"]):hover,
    ...
    @media (max-width: 760px) {
        div[data-testid="stHorizontalBlock"]:has(.cx-top-active),
        div[data-testid="stHorizontalBlock"]:has(.cx-top-item) {
            padding: 0 10px !important; gap: 4px !important;
        }
        .cx-top-active [data-testid^="stPageLink"],
        .cx-top-item [data-testid^="stPageLink"] { padding: 0 3px !important; }
        div[data-testid="stHorizontalBlock"]:has(.cx-top-active) a p,
        div[data-testid="stHorizontalBlock"]:has(.cx-top-item) a p {
            font-size: .69rem !important; line-height: 1.08 !important;
        }
    }
    </style>
    """, unsafe_allow_html=True)
