...
PAGE_BADGES = {
    ...
    "tracking": ("📍", "AI Oversight & Evidence"),
}
...
PROBLEM_SELECTION_ITEMS = [
    ...
    ("governance_board", "✅ Portfolio Dashboard", "pages/5_Analytics_Dashboard.py"),
]
    ...
    with st.sidebar:
        ...
        if items:
            ...
            for code, label, target in items:
                ...
                css = "cx-nav-item cx-nav-active" if is_active else "cx-nav-item"
